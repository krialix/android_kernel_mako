...
KERNELFLAGS		= -DNDEBUG -munaligned-access -fgcse-lm -fgcse-sm -fgcse-las -fsched-spec-load -fforce-addr -ffast-math -fsingle-precision-constant -mtune=cortex-a15 -marm -march=armv7-a -mfpu=neon-vfpv4 -ftree-vectorize -mvectorize-with-neon-quad -funsafe-loop-optimizations -fpredictive-commoning -fira-loop-pressure -fsection-anchors -fivopts -ftree-loop-im -ftree-loop-ivcanon -ffunction-sections -fweb -ffp-contract=fast
...
CFLAGS_A15 = -mtune=cortex-a15 -marm -mfpu=neon-vfpv4 -fgcse-las \
			 ...
			 -ffast-math -munaligned-access -fsingle-precision-constant -fipa-pta -funswitch-loops
ifdef CONFIG_CC_GRAPHITE_OPTIMIZATION
CFLAGS_A15 += -fgraphite-identity -floop-parallelize-all -ftree-loop-linear -floop-interchange -floop-strip-mine -floop-block
endif
